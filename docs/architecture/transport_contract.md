# AlphaX Transport Contract

Status: Stable 1.0 contract. Dart IO, Android Cronet, Apple URLSession, and
browser Fetch adapters implement their applicable portions; provider capability
