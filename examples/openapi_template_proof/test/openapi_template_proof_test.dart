...
void main() {
  ...
  test(
    'official OpenAPI template plus alphax_generator reaches AlphaX directly',
    () async {
  ...
  test(
    'the generated declaration and implementation have no framework runtime seam',
    () {
      for (final path in <String>[
        'lib/users_api.dart',
        'lib/users_api.g.dart',
      ]) {
