...
/// Creates a connector backed by the browser WebSocket API through the
/// maintained `package:web_socket` abstraction.
///
/// Browser TLS, origin, cookies, CSP, network policy, and arbitrary request
/// headers remain browser-owned. This connector does not emulate native header
/// support.
...
final class _AlphaXWebSocketConnector implements AlphaXWebSocketConnector {
  static const _capabilities = AlphaXWebSocketCapabilities(
    transportName: 'package:web_socket (browser WebSocket)',
