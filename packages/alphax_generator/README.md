...
This package is the direct annotation generator foundation. OpenAPI templates,
Protobuf ergonomics, and framework-specific generator integrations are separate
follow-up decisions.
