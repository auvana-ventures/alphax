...
AlphaXCapabilities androidCapabilitiesFromNative(Object? raw) {
  ...
  return AlphaXCapabilities(
    ...
    tlsDefaultTrust: support('tlsDefaultTrust'),
    customTrustAnchors: support('customTrustAnchors'),
    certificatePinning: support('certificatePinning'),
    mutualTls: support('mutualTls'),
    systemProxy: support('systemProxy'),
    directConnectionPolicy: support('directConnectionPolicy'),
    explicitHttpProxy: support('explicitHttpProxy'),
    explicitHttpsProxy: support('explicitHttpsProxy'),
    proxyAuthentication: support('proxyAuthentication'),
    protocolRequirement: support('protocolRequirement'),
